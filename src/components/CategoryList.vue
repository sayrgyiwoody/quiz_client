        ...
        <div class="mx-auto max-w-5xl mt-4 md:mt-6">
                <h4 class="flex items-center justify-between mb-3">
                        <div class="flex items-center">
                                <svg class="text-violet-500 inline-block" xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M17 3a4 4 0 1 0 0 8a4 4 0 0 0 0-8ZM3 17a4 4 0 1 1 8 0a4 4 0 0 1-8 0Zm10-3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v5a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2v-5ZM3 4a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v5a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4Z" clip-rule="evenodd"/></svg>
                        <span class="ms-2 font-medium text-violet-500">
                ...
                <div class="grid grid-cols-3 md:grid-cols-6 gap-3">
                        <div @click="categoryFilter(c.id)" v-for="(c, index) in displayedCategories" :key="index" class="animate__animated animate__bounceIn cursor-pointer bg-white dark:bg-zinc-800 h-fit hover:bg-slate-50 dark:hover:bg-zinc-700 duration-150 shadow-sm hover:shadow px-3 py-2 group rounded">
                            ...
                            <p class="mt-2 text-sm md:text-base group-hover:text-blue-500 text-center text-zinc-800 dark:text-slate-200">{{c.name}}</p>
                            <p class="text-center text-sm text-slate-600 dark:text-muted font-semibold">quizzes : {{c.quizzes_count}}</p>
