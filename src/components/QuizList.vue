<template>
    ...
    <div  v-for="(quiz,index) in quizzes" :key="index" class=" animate__animated animate__bounceIn bg-white dark:bg-zinc-800 hover:bg-slate-50 dark:hover:bg-zinc-700 shadow rounded-md border border-slate-200 dark:border-zinc-700 h-fit">
