<template>
    <side-nav></side-nav>
     <div class=" bg-slate-100 dark:bg-zinc-900 min-h-screen">
        <top-nav></top-nav>
...
import SavedQuizzes from './library/SavedQuizzes.vue';
import CreatedByMe from './library/CreatedByMe.vue';
