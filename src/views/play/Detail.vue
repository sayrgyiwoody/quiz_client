<template>
    ...
    <div class="bg-white dark:bg-zinc-800 px-6 py-4 rounded shadow max-w-xl mx-auto font-poppins">
        ...
        <div class="flex items-center space-x-2">
            ...
            <button @click="playQuiz(quiz.quiz_id)" class="px-6 flex items-center group bg-indigo-600 hover:bg-indigo-500 dark:bg-indigo-500  hover dark:hover:bg-indigo-600  text-white py-2 rounded-md mt-3 font-medium ">
                Play
