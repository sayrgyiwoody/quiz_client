<template>
    <div class="bg-white dark:bg-zinc-800 px-6 py-4 rounded shadow max-w-xl mx-auto mt-3 md:mt-6">
        <h4 class=" capitalize rounded-l-sm border-l-4 ps-2 border-primary dark:border-blue-500 text-zinc-900 dark:text-white text-2xl font-semibold mb-3">{{quiz.title}}</h4>
        ...
        <div class="flex">
            <button @click="returnBack()" class="flex items-center group bg-primary hover:bg-primary_hover text-white px-4 py-2 rounded mt-3 font-medium">
            ...
            <button @click="playQuiz(quiz.quiz_id)" class="ms-3 flex items-center group bg-primary hover:bg-primary_hover text-white px-4 py-2 rounded mt-3 font-medium">
                Play
        ...
        <p class="text-zinc-800 dark:text-slate-200">Played by : <span class=" text-primary dark:text-blue-500">{{played_count}}</span> User</p>      
