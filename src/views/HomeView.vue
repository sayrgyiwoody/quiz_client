<template>
    <div class="pb-4">
        ...
        <div class="mx-auto max-w-2xl flex">
            ...
            <div @click="directAll" class="animate__animated animate__bounceIn font-medium hover:bg-slate-50 dark:hover:bg-zinc-700 duration-150 w-2/6 text-zinc-900 dark:text-white bg-white shadow dark:bg-zinc-800 flex items-center justify-center ms-3 rounded px-3 dark:border border-zinc-800 border-0 dark:border-zinc-100">
        ...
        <div v-if="searchKey" class="mx-auto max-w-5xl mt-4">
            ...
            <div class="grid md:grid-cols-3 md:gap-3 gap-y-3">
                ...
                <quiz-list :quizzes="searched_quizzes">
