    ...
    <div class=" font-poppins animate__animated animate__fadeIn mt-6 flex items-center justify-center flex-col">
        ...
        <div class="max-w-lg mt-4 p-6  bg-white dark:bg-zinc-800 shadow-sm rounded">
            ...
            <form @submit.prevent="requestPassword" class="mt-5">
                ...
                <label class="peer-focus:font-medium absolute bg-white dark:bg-zinc-800 text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 left-3 -z-10 peer-focus:z-20 text-zinc-900  origin-[0]  peer-focus:bg-white dark:peer-focus:bg-zinc-800 px-3 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-5">Your Email</label>
                </div>
