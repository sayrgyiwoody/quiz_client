<template>
        ...
        <div class="w-full sm:w-auto max-w-lg mx-auto bg-white dark:bg-zinc-800 shadow px-6 py-4 rounded mt-8 md:mt-20">
            ...
            <div class="flex items-center justify-center space-x-3">
                ...
                <a @click="socialiteLogin" href="http://127.0.0.1:8000/auth/github/redirect" class="border-[1.5px] border-slate-200 dark:border-zinc-600 hover:bg-slate-50 dark:hover:bg-zinc-700 duration-150 rounded-xl px-3 py-2 flex  items-center justify-center font-semibold text-zinc-800 dark:text-slate-200">
                ...
                <a @click="socialiteLogin" href="http://127.0.0.1:8000/auth/google/redirect" class="border-[1.5px] border-slate-200 dark:border-zinc-600 hover:bg-slate-50 dark:hover:bg-zinc-700 duration-150 rounded-xl px-3 py-2 flex  items-center justify-center font-semibold text-zinc-800 dark:text-slate-200">
                ...
                <a @click="socialiteLogin" href="http://localhost:8000/auth/facebook/redirect" class="border-[1.5px] border-slate-200 dark:border-zinc-600 hover:bg-slate-50 dark:hover:bg-zinc-700 duration-150 rounded-xl px-3 py-2 flex  items-center justify-center font-semibold text-zinc-800 dark:text-slate-200">
                    ...
                    <!-- <svg class=" inline-block me-2 w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 128 128"><rect width="118.35" height="118.35" x="4.83" y="4.83" fill="#3d5a98" rx="6.53" ry="6.53"/><path fill="#fff" d="M86.48 123.17V77.34h15.38l2.3-17.86H86.48v-11.4c0-5.17 1.44-8.7 8.85-8.7h9.46v-16A126.56 126.56 0 0 0 91 22.7c-13.62 0-23 8.3-23 23.61v13.17H52.62v17.86H68v45.83z"/></svg> -->
                    Facebook
                </a>
            </div>
        </div>
