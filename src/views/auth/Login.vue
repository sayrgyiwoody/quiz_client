<template>
        ...
        <div class="w-full sm:w-auto max-w-lg mx-auto bg-white dark:bg-zinc-800 shadow px-6 py-4 rounded mt-8 md:mt-20">
            ...
            <div class="flex items-center justify-center space-x-3">
                <a href="http://127.0.0.1:8000/auth/google/redirect" class="border-[1.5px] border-gray-300 dark:border-zinc-600 hover:bg-slate-50 dark:hover:bg-zinc-700 duration-150 rounded px-4 py-3 flex  items-center justify-center font-semibold text-zinc-800 dark:text-slate-200">
                ...
                <a href="http://127.0.0.1:8000/auth/github/redirect" class="border-[1.5px] border-gray-300 dark:border-zinc-600 hover:bg-slate-50 dark:hover:bg-zinc-700 duration-150 rounded px-4 py-3 flex  items-center justify-center font-semibold text-zinc-800 dark:text-slate-200">
