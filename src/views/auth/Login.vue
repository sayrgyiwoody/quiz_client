<template>
        ...
        <div class="w-full sm:w-auto max-w-lg mx-auto bg-white dark:bg-zinc-800 shadow px-6 py-4 rounded mt-8 md:mt-20">
            ...
            <div class="flex items-center justify-center space-x-3">
                ...
                <a @click="socialiteLogin" :href="`${api_url}/auth/github/redirect`" class="border-[1.5px] border-slate-200 dark:border-zinc-600 hover:bg-slate-50 dark:hover:bg-zinc-700 duration-150 rounded-xl px-3 py-2 flex  items-center justify-center font-semibold text-zinc-800 dark:text-slate-200">
                ...
                <a @click="socialiteLogin" :href="`${api_url}/auth/google/redirect`" class="border-[1.5px] border-slate-200 dark:border-zinc-600 hover:bg-slate-50 dark:hover:bg-zinc-700 duration-150 rounded-xl px-3 py-2 flex  items-center justify-center font-semibold text-zinc-800 dark:text-slate-200">
