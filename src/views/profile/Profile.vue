        ...
        <form @submit.prevent="updateProfileInfo" class="w-full px-6 py-3 md:px-7 md:py-4 max-w-3xl bg-white dark:bg-zinc-800 shadow-sm rounded">
            ...
            <div class="md:grid md:grid-cols-3 md:space-x-6">
                ...
                <div class=" col-span-2">
                    ...
                    <div v-if="userData.provider !== null && userData.provider !== '' && userData.provider !== undefined && userData.email " class="relative z-0 w-full mb-6 group mt-6">
                        <input readonly v-model="userData.email" name="email" type="text" class="read-only:-z-10  border-slate-300 dark:border-zinc-700 dark:text-white px-3 relative block py-3 w-full text-sm text-gray-900 bg-transparent appearance-none border-[1.5px]  rounded-md dark:focus:border-blue-500 -z-0 focus:outline-none focus:ring-0 focus:border-blue-600 " placeholder=" " required />
                        <label class="bg-white dark:bg-zinc-800 absolute text-sm dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 left-3 -z-10 text-zinc-900  origin-[0]  peer-focus:bg-white dark:peer-focus:bg-zinc-800 px-3 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-5">Email</label>
                    </div>
                    <div v-if="userData.provider === null || userData.provider === '' || userData.provider === undefined" class="relative z-0 w-full mb-6 group mt-6">
