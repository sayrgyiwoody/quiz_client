            ...
            <div class="md:grid md:grid-cols-3 md:space-x-6">
                ...
                <div class=" col-span-2">
                    ...
                    <div class="relative z-0 w-full mb-6 group mt-6">
                        <input :readonly="userData.provider !== null && userData.provider !== '' && userData.provider !== undefined " v-model="userData.email" name="email" type="text" class="read-only:-z-10  border-slate-300 dark:border-zinc-700 dark:text-white px-3 relative block py-3 w-full text-sm text-gray-900 bg-transparent appearance-none border-[1.5px]  rounded-md dark:focus:border-blue-500 -z-0 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
